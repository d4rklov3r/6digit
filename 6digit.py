# DECRYPTED BY D4RK LOV3R
# Github : git clone https://github.com/d4rklov3r
 #!/usr/bin/python
# -*- coding: utf-8
...
print("\033[0;91mThis Tool's Free By D4RK LOV3R")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : D4RK LOV3R'
    print '\033[0;94mFACEBOOK : RAFID RAFI'
    print '\033[0;96mGITHUB   : D4RK LOV3R'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[D4RK-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
